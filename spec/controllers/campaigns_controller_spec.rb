...
RSpec.describe CampaignsController, type: :controller do
  ...
  describe 'GET #show' do
    ...
    context 'campaign dont exists' do
      it 'Redirects to root' do
  ...
  describe 'DELETE #destroy' do
    ...
    context 'User isnt the Campaign Owner' do
    ...
    context 'User is the Campaign Owner' do
      before(:each) do
        ...
        put :update, params: { id: campaign.id,
                               campaign: @new_campaign_attributes }
      end
      ...
      it 'Campaign have the new attributes' do
        title = @new_campaign_attributes[:title]
        description = @new_campaign_attributes[:description]
